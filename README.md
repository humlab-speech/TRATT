...
TRATT is a fork of [OCTRA](https://github.com/IPS-LMU/octra), developed at the Institute of Phonetics and Speech Processing, LMU Munich. It serves the particular needs of the Visible Speech speech research platform and the aim of [Språkbanken CLARIN](https://sprakbanken.se/om-oss/organisation-och-verksamhet/sprakbanken-clarin) and [Humlab](https://www.umu.se/humlab/) at Umeå University to support more efficient work on
