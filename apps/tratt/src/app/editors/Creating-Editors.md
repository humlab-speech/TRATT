...
TRATT supports creating new editors. This tutorial explains how to do it.

1. Go to the Terminal and go to directory src/app/editors
2. Duplicate an existing editor folder (e.g. dictaphone-editor) and rename as you need. You need to rename the folder and its files, the class name and the "@Component" Decorator.
...
7. After you have reloaded TRATT it should show the newly created editor in the navbar. When you click on it the editor is loaded.
