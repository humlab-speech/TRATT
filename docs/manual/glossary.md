...
| **Tier** / **Level** | One layer of annotation over the recording: a sequence of transcription units. A transcript can have several — a translation, one per speaker. *Level* is the older word; the two mean the same. |
